  ...
  return (
    <div className="MainDetail">
      ...
      <div className="fullDetail">
        <p>
          Senior lawyer after having acquired extensive knowledge and experience
          across all spheres of law by practically passing through all sorts of
          cases assigned to her, whether relating to financial banking
          institutes, commercial enterprises, family matters, rent cases or
          property disputes. She has not only been providing legal services to
          banking institutes but also providing them with services to their
          Credit Administration Department (CAD) for compliance of legal
          formalities to safeguard their interests. With efficient and
          well-experienced staff, transfer, mutation, mortgage, redemption,
          verification of genuineness of property, rent/lease agreements and its
          registration with concerned authorities or societies is more secured.
          In her past, she has worked with M/s. Ataur Rehman & Co., Advocates
          for pupilage in 1984, successfully completed training and enrolled as
          an advocate of Subordinate Courts. Conducted a number of cases of
          various natures independently including banking matters and matters
          relating to commercial transactions. After having gained rich
          experience in diverse fields of law, she was enrolled as an advocate
          of High Courts in October 1999.{" "}
        </p>
      </div>
